...
soup = BeautifulSoup(open(url + 'host/192.168.50.229.html' ,encoding='utf8'),features="html.parser")
...
table = document.add_table(rows=2, cols=4, style="Light Shading")
...
table = document.add_table(rows=ror, cols=3, style="Light Shading")
hdr_cells = table.rows[0].cells
hdr_cells[0].text = '序号'
